...
class GoScanner(Scanner):
    ...
    def _scan_with_go_command(self, path: Path, include_dev: bool) -> List[Dict[str, Any]]:
    ...
    def _enhance_with_go_sum(self, path: Path, components: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
