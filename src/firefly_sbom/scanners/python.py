...
class PythonScanner(Scanner):
        ...
        try:
            ...
            for package in lock_data.get("package", []):
                ...
                component = self.create_component(
                    ...
                    version=version,
                    type="library",
                    scope="direct" if package.get("category") == "main" else "transitive",
    ...
    def _scan_poetry_pyproject(self, path: Path, include_dev: bool) -> List[Dict[str, Any]]:
            ...
            if match:
                ...
                for line in requires_str.split(','):
                    ...
                    if pkg_match:
                        ...
                        version = pkg_match.group(3).strip() if pkg_match.group(3) else "*"
