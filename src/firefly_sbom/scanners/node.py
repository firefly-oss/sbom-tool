...
class NodeScanner(Scanner):
    ...
    def _parse_package_json(self, path: Path, include_dev: bool) -> List[Dict[str, Any]]:
    ...
    def _parse_package_lock(self, path: Path, include_dev: bool) -> List[Dict[str, Any]]:
    ...
    def _parse_npm_v1_deps(self, dependencies: Dict, include_dev: bool) -> List[Dict[str, Any]]:
        ...
        for name, info in dependencies.items():
            ...
            if 'dependencies' in info:
                nested_components = self._parse_npm_v1_deps(info['dependencies'], include_dev)
    ...
    def _parse_npm_v2_packages(self, packages: Dict, include_dev: bool) -> List[Dict[str, Any]]:
    ...
    def _get_framework_components(self, path: Path, project_type: str) -> List[Dict[str, Any]]:
    ...
    def _enhance_with_npm_info(self, path: Path, components: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    def _generate_purl(self, name: str, version: str, group: Optional[str] = None) -> str:
