...
class FlutterScanner(Scanner):
    ...
    def _parse_pubspec_lock(self, path: Path, include_dev: bool) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            for name, info in packages.items():
                ...
                component = self.create_component(
                    ...
                    description=description.get('name') if isinstance(description, dict) else None
                )
    ...
    def _parse_pubspec_yaml(self, path: Path, include_dev: bool) -> List[Dict[str, Any]]:
    ...
    def _enhance_with_flutter_info(self, path: Path, components: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
                ...
                for component in components:
                    ...
                    if name in deps_data:
                        ...
                        if 'license' in dep_info:
                            component['license'] = self._normalize_license(dep_info['license'])
