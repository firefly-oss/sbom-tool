...
class RubyScanner(Scanner):
    ...
    def _parse_gemfile_lock(self, path: Path, include_dev: bool) -> List[Dict[str, Any]]:
    ...
    def _enhance_with_bundler(self, path: Path, components: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
