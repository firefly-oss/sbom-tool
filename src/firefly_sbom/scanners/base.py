...
class Scanner(ABC):
    ...
    def _generate_bom_ref(self, name: str, version: str, group: Optional[str] = None) -> str:
    ...
    def _calculate_file_hash(self, path: Path, algorithm: str = "sha256") -> Optional[str]:
    ...
    def _normalize_license(self, license_str: str) -> str:
        ...
        spdx_identifiers = [
            ...
            "GPL-3.0", "LGPL-3.0", "MPL-2.0", "ISC", "Unlicense"
        ]
