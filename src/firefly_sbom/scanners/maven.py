...
class MavenScanner(Scanner):
    ...
    def _parse_maven_tree(self, tree_data: Dict, include_dev: bool) -> List[Dict[str, Any]]:
    ...
    def _process_maven_artifact(
        ...
        if 'children' in artifact:
            for child in artifact['children']:
                self._process_maven_artifact(child, components, include_dev, "transitive")
    
    def _parse_maven_text_tree(self, path: Path, include_dev: bool) -> List[Dict[str, Any]]:
    ...
    def _parse_dependency_tree_text(self, tree_text: str, include_dev: bool) -> List[Dict[str, Any]]:
    ...
    def _parse_single_pom(self, pom_file: Path, include_dev: bool) -> List[Dict[str, Any]]:
