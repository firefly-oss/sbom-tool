...
class RustScanner(Scanner):
                ...
                if 'members' in workspace:
                    for member in workspace['members']:
                        ...
                        if member_path.exists():
                            member_components = self._parse_cargo_toml(member_path, include_dev)
    ...
    def _enhance_with_cargo(self, path: Path, components: List[Dict[str, Any]], include_dev: bool) -> List[Dict[str, Any]]:
                ...
                for package in metadata.get('packages', []):
                    ...
                    if name in comp_map:
                        ...
                        if 'license' in package:
                            comp['license'] = self._normalize_license(package['license'])
